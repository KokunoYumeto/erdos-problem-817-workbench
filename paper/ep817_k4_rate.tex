...
The accompanying Lean 4 module certifies, without `sorry`, the following exact
claims:
...
\end{enumerate}
The Lean module does not yet certify the full minimal-block decomposition, the
